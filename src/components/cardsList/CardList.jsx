      ...
      <Card>
        <CardInner className="cardInner">
          ...
          <BackCard brown>
            ...
            <BackCardParagraph>
              The Protos Trend Index is based on a trend-following strategy.
              This Stack is updated every week by Protos Management to stay on
      ...
      <Card>
        <CardInner className="cardInner">
          ...
          <BackCard green>
            ...
            <BackCardParagraph>
              Robinhood 6 tracks the total return of the 6 cryptoassets offered
              on the popular Robinhood app, that are also listed on Binance,
